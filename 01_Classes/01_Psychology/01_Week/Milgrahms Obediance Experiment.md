...
tags: [psychology,Milgrams, Obediance, lecture, 2026-03-30]
date: 2026-03-30
...
*   **Relevant Biological Processes:** What,why,Next ,Change
	* In the setup:
		* Experimenter - The Authority in the Lab Coat
...
* **[[Situational Factors]]**: Small changes in the situation that change obedience allot
	* Proximity: 
		...
		* How close the victim is to you
			* ex: It is easier to follow harsh orders from a boss over e-mail than if they are right next to you and its easier to harm someone if you cannot see them than it is if they are right in front of you
	* Peers: What are people doing around you
		* if those peers obeyed obedience stayed high
		* if peers disobeyed oebience dropped
		* Peer dissent: if a peer says no its easier for me to say no
			* aka its easier when one person goes first
				* Example: 
	* P.L.A.P. (Proximity Legitimacy Authority Peers):
		* Proximity -  of authority to you
		* Legitimacy - how official the authority seems
		* Authority pressence - in the room or not
		* Peers dissent - are others saying no or notwwwwwwwwwwwwwwd
...
- A teacher says: “Put your phones away.” → everyone (mostly) does it.
- A doctor says: “Take this pill twice a day.” → you follow the instructions.

In Milgram's study , the **Experimenter** says things like :
	"The experiment requires you to continue", 
	when the teacher keeps pressing the shock button that is obedience!
...
## 🔗 Related Notes
*   About **65%** of people went all the way to the **maximum shock** level when the authority pushed them to continue.
