...
- Each object keeps its **own** attribute values (independent state).
...
- `car1`, `car2` = variables (labels)
- `Car()` = creates a new object

**3. Giving each object its own attributes**
...
- `.` (dot) is how you set/read attributes on that specific object.
...
**5. Variable vs. attributes**

- Variable: `car1` (points to an object)
- Attributes: `car1.color`, `car1.speed` (data stored _inside_ that object)
